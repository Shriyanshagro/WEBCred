...
string = "URL , " + "Contact , " + "Email , " + "Help , " + "Recommend , " + "Sitemap , " +"Image:text Ratio , " + "Ad Count , " + "Broken Links , " + 'Cookies , ' + "Total supported Lang , " + "Misspelled words , " + "Last Modified , " + "Domain , " + "Inlinks , "+"Oulinks , "+"PageloadTime , "
temp2.write(string+'\n')
urls = [
...
def check_size_ratio(url):
    ratio = {'Image:text Ratio':'Page NA'}
    # need to specify header for scrapping otherwise some websites doesn't allow bot to scrap
    hdr = {'User-Agent': 'Mozilla/5.0'}
    # You should use the HEAD Request for this, it asks the webserver for the headers without the body.
    try:
    ...
    for link in soup.find_all('img',src=True):
        ...
        if links!="":
            ...
            try:
                ratio = txt_size/(total_img_size+txt_size)
            except ValueError:
                ratio = 'Page NA'
    ...
    while i<len(urls):
        ...
        if url!="" and not ( url.startswith('http://') or url.startswith('https://') ):
            ...
            if check_ratio==1:
                ...
                # print url,count
                string+= " , " + str(count['Image:text Ratio'])
